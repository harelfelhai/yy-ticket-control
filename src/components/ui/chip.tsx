 ...
 * `neutral` — מצב ללא דחיפות ובלי שקרה דבר ("שויך").
 ...
 * `info` — פנייה חדשה שטרם נצפתה, וערך בטיוטה ממייל שאף אדם לא בדק (1.3).
 *   ירש מ-`brand` את המשמעות היחידה שהייתה לו כמצב, כשהמותג הפך לגרפיט
 *   וחדל להיות מובחן מטקסט רגיל.
