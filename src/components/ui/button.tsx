 ...
 *
 * **הגובה תלוי במכשיר ולא בווריאנט.** שניהם יורדים ל-32px ול-28px בעכבר,
 ...
 * רצפת המגע לא זזה. הערכים כאן הם **מקור האמת** לרצפה הנמדדת בשתי חבילות
 * ה-Playwright — `layout-guards.test.ts` גוזר אותה מכאן ואוסר עליה לסטות.
 *
...
const SIZES: Record<ButtonSize, string> = {
  default: "min-h-8 px-3 text-sm touch:min-h-11 touch:px-4",
  compact: "min-h-7 px-2 text-sm touch:min-h-11 touch:px-3",
};
