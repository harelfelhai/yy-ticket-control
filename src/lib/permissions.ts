...
export function canViewTicket(
  ...
  switch (viewer.role) {
    ...
    case "OWNER":
      return true;
    /**
     * **שני כובעים, לא אחד.** §5.ז מונה את מנהל העבודה ואת הנמען
     * לטיפול כשני סעיפים נפרדים, ואותו אדם יכול להיות שניהם באותה עת:
     *
     * - כמנהל עבודה — "אך ורק האתר שלו — ובתוכו **כל** הפניות".
     * - כנמען לטיפול — "אך ורק פניות ששויכו אליו, **מכל האתרים**".
     *
     * עד 1.9.2026 נבדק כאן הכובע הראשון בלבד, ולכן מנהל עבודה ששויך
     * כנמען לפנייה באתר אחר קיבל עליה מייל ונחת על 404. ה-OR הזה הוא
     * הכובע השני, והוא **אינו מרחיב את המידור**: הוא נפתח אך ורק על פנייה
     * שמנהל אחר שייך אליו במפורש, ונסגר ברגע שהשיוך מוסר (`REMOVED`).
     */
    case "SITE_MANAGER":
      if (viewer.siteId !== null && viewer.siteId === ticket.siteId) return true;
