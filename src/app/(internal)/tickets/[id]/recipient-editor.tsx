 ...
 *
 * ההפרדה בין שני האחרונים היא העיקר. התג אומר **שיוך** — שהמערכת שייכה
 * אותו — ושורת השליחה שמתחתיו אומרת אם מישהו באמת יודע. ההבחנה הזו היא
 * ההבדל בין מנהל שיודע שהקבלן קיבל לבין מנהל שמניח שכן.
 *
 * עד 1.1 שתי השורות השתמשו באותה מילה בדיוק: התג אמר "נשלח" ומתחתיו
 * הופיע "ההודעה בתור לשליחה". התג נקרא "שויך" מאז (`he.assignmentStatus`),
 * והמילה "נשלח" שמורה לשורה שבאמת מודדת מסירה.
 *
